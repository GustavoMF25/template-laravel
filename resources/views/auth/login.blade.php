    ...
    <div class="flex min-h-screen">
        <div class="bg-gradient-to-t from-[#0074D9] to-[#D29218] w-1/2  min-h-screen hidden lg:flex flex-col items-center justify-center text-white p-4">
            <div class="w-full mx-auto mb-5">
                <img src="/assets/images/icon-colege.png" alt="coming_soon" class="lg:max-w-[370px] xl:max-w-[500px] mx-auto" />
            </div>
            <h3 class="text-3xl font-bold mb-4 text-center">Bem vindo ao sistema Colege - App</h3>
        ...
        <div class="w-full lg:w-1/2 relative flex justify-center items-center">
            <div class="max-w-[580px] p-3 md:p-5">
                ...
                <!-- <ul class="flex justify-center gap-2 sm:gap-5 mb-5">
                    <li>
                        <button type="button"
                            class="btn flex gap-1 sm:gap-2 text-black shadow-none bg-white-dark/30 hover:bg-white ">
