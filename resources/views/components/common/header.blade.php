<header :class="{ 'dark': $store.app.semidark && $store.app.menu === 'horizontal' }">
    <div class="shadow-sm">
        <div class="relative bg-white flex w-full items-center px-5 py-2.5">
            ...
            <div class="ltr:mr-2 rtl:ml-2 hidden sm:block">
                <ul class="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    <li><a href="#" class="block p-2 rounded-full bg-white-light/40 hover:text-primary hover:bg-white-light/90">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div x-data="header" class="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse">
                ...
                <div class="dropdown" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="block p-2 rounded-full bg-white-light/40 hover:text-primary hover:bg-white-light/90" @click="toggle">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="top-11 !py-0 text-dark w-[300px] ltr:-right-16 sm:ltr:-right-2 rtl:-left-16 sm:rtl:-left-2 sm:w-[375px] text-xs">
                        <li class="mb-5">
                        ...
                        <template x-for="msg in messages">
                            <li>
                                <div class="flex items-center px-5 py-3" @click.self="toggle">
                                    ...
                                    <span class="px-3">
                                        <div class="font-semibold text-sm" x-text="msg.title"></div>
                                        <div x-text="msg.message"></div>
                                    </span>
                                    <span class="font-semibold bg-white-dark/20 rounded text-dark/60 px-1 ltr:ml-auto rtl:mr-auto whitespace-pre ltr:mr-2 rtl:ml-2" x-text="msg.time"></span>
                        ...
                        <template x-if="messages.length">
                            <li class="border-t border-white-light text-center mt-5 ">
                                <div class="flex items-center px-4 py-4 text-primary font-semibold group  justify-center cursor-pointer" @click="toggle">
                ...
                <div class="dropdown" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative block p-2 rounded-full bg-white-light/40 hover:text-primary hover:bg-white-light/90" @click="toggle">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:-right-2 rtl:-left-2 top-11 !py-0 text-dark w-[300px] sm:w-[350px] divide-y">
                        <li>
                                ...
                                <div class="flex items-center px-4 py-2 group" @click.self="toggle">
                                    ...
                                    <div class="ltr:pl-3 rtl:pr-3 flex flex-auto">
                                        <div class="ltr:pr-3 rtl:pl-3">
                                            ...
                                            <span class="text-xs block font-normal" x-text="notification.time"></span>
                                        </div>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0 text-dark top-11 !py-0 w-[230px] font-semibold">
                        <li>
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <h4 class="text-base">{{ Auth::user()->name }}<span class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">Pro</span>
                                    </h4>
                                    <a class="text-black/60  hover:text-primary" href="javascript:;">{{ Auth::user()->email }}</a>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li class="border-t border-white-light">
                            ...
                            <!-- <x-dropdown-link :href="route('logout')" onclick="event.preventDefault();
                                this.closest('form').submit();">
                                <form method="POST" class=" text-danger" action="{{ route('logout') }}">
                                    @csrf
                                    {{ __('Log Out') }}
                                </form>
                            </x-dropdown-link> -->
        ...
        <!-- horizontal menu -->
        <ul class="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] text-black">
            ...
            <li class="menu nav-item relative">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="relative">
                        ...
                        <ul class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark shadow p-0 py-2 hidden">
                            <li>
