        ...
        <div class="bg-white h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/icon-colege.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline">{{ config('app.name', '') }}</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'dashboard' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black">Dashboard</span>
                        </div>
                ...
                <h2
                    class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 -mx-4 mb-1">
                        ...
                        <li class="nav-item">
                            <a href="/apps/calendar" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black">Calendar</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black">Components</span>
                        </div>
