<div x-data="customizer">
    ...
    <nav class="bg-white fixed ltr:-right-[400px] rtl:-left-[400px] top-0 bottom-0 w-full max-w-[400px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] p-4"
        ...
        <div class="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
            <div class="text-center relative pb-5">
                <a href="javascript:;"
                    class="absolute top-0 ltr:right-0 rtl:left-0 opacity-30 hover:opacity-100"
            ...
            <div class="border border-dashed border-[#e0e6ed] rounded-md mb-3 p-3">
